...
public class Humano implements Observer {
    ...
    public void display() {
        ...
        switch (acontecimento) {
            case "Gol":
                System.out.println("Gol! " + "Minuto: " + tempo + "'\n");
                break;
            case "Primeiro Tempo":
                System.out.println("-- Resultado do Primeiro Tempo --\n" +
                        "Mandantes: " + mandantes +
            ...
            case "Resultado da partida":
                for (Partida m : partidas) {
                    ...
                    System.out.println(m.nomeDoMandante + " " + mandantes + " - " + visitantes + " " + m.nomeDoVisitante + "\n");
                    break;
                }
        }
    }
